...
#include <media/msm_jpeg_dma-legacy-m.h>
	...
	struct vb2_queue *dst_vq)
{
	...
	src_vq->buf_struct_size = sizeof(struct vb2_v4l2_buffer); // Merge conflict
	...
	dst_vq->buf_struct_size = sizeof(struct vb2_v4l2_buffer); // Merge conflict
